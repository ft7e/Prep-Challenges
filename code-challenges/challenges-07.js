...
const objLat = (obj) => {
  ...
  const capitalLetter = function (input) {
    let firstLetter = input.replace(input[0], input[0].toUpperCase());
    return firstLetter;
  };

  return `my name is ${capitalLetter(obj.firstName)} ${capitalLetter(
    obj.lastName
